  ...
  if(isset($_POST['p_name']) && strlen($_POST['p_name']))
  {
    ...
    if($results = find_all_product_info_by_title($product_title)){
        foreach ($results as $result) {
          ...
          $html  .= "<td>";
          $html  .= "<input type=\"text\" class=\"form-control\" name=\"Codigo\" value=\"{$result['Codigo']}\">";
          $html  .= "</td>";
          $html .= "<td id=\"cedula\">";
          $html .= "<input type=\"text\" class=\"form-control\" name=\"cedula\" value=\"1\">";
          ...
          $html  .= "</td>";
          $html  .= "<td>";
          $html  .= "<a href=\"sales.php\" class=\"btn btn-success\">Cancelar</a>";
          $html  .= "</td>";
          $html  .= "</tr>";
