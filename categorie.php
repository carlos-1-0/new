                    ...
                    <td class="text-center">
                      <div class="btn-group">
                        ...
                        <script type="text/JavaScript">
                                            function confirmar() {
                                                var respuesta= confirm("¿Seguro que desea eliminar esta categoria?");
                                                if (respuesta==true) {
                                                    return true;
                                                }else{
                                                    return false;
                        ...
                        <a href="delete_categorie.php?id=<?php echo (int)$cat['id'];?>"  class="btn btn-xs btn-danger" onclick="return confirmar()" data-toggle="tooltip" title="Eliminar">
