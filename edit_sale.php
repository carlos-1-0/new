  ...
  if(isset($_POST['update_sale'])){
    ...
    validate_fields($req_fields);
        if(empty($errors)){
          ...
          $sql .= " product_id= '{$p_id}',qty={$s_qty},price='{$s_price}',Total='{$s_total}',date='{$s_date}'";
          ...
          if( $result && $db->affected_rows() === 1){
                    ...
                    $session->msg('d','Lo sentimos fallo la actualizacion');
  ...
  <div class="panel">
    <div class="panel-heading clearfix">
     ...
     <div class="pull-right">
       <a href="sales.php" class="btn btn-success">Volver</a>
     </div>
    </div>
          ...
          <th> Accion</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td id="s_date">
                  <input type="date" class="form-control datepicker" name="date" data-date-format="Y-m-d" value="<?php echo remove_junk($sale['date']); ?>">
                </td>
                <td>
