           ...
           <td class="text-center">
             <div class="btn-group">
               ...
               <script type="text/JavaScript">
                                            function confirmar() {
                                                var respuesta= confirm("¿Seguro que desea eliminar este grupo?");
                                                if (respuesta==true) {
                                                    return true;
                                                }else{
                                                    return false;
                ...
                <a href="delete_group.php?id=<?php echo (int)$a_group['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" onclick="return confirmar()" title="Eliminar">
