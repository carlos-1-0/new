<ul>
  ...
  <li>
    ...
    <ul class="nav submenu">
       <li><a href="cliente.php">Administrar de cliente</a> </li>
  ...
  <li>
    <a href="#" class="submenu-toggle">
      ...
      <ul class="nav submenu">
         <li><a href="gastos.php">Administrar gastos</a> </li>
         <li><a href="add_gasto.php">Agregar gasto</a> </li>
     </ul>
  </li>
  <li>
    <a href="#" class="submenu-toggle">
